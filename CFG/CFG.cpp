...
std::vector<std::string> CFG::getProductions(char variable){
	std::vector<std::string> vec;
	std::pair< std::multimap< char, std::string>::iterator, std::multimap< char, std::string>::iterator > gebied;
	gebied = productions.equal_range( variable );

	for ( std::multimap<char, std::string>::iterator it=gebied.first; it != gebied.second; ++it){
...
bool CFG::isInMultimap( std::pair<char, std::string> p){//nieuw
	std::pair< std::multimap< char, std::string>::iterator, std::multimap< char, std::string>::iterator > gebied;
	gebied = productions.equal_range( p.first );
