...
CNF staat in de CNF-directory, het kan gerund worden met het commando "sh run.sh" in de terminal.
De inputbestanden zijn verzameld in de subdirectory "input".
Om een  ander bestand te lezen moet het run bestand aangepast worden op regel 6.
Het algoritme geeft die 3 outputs:
	-net na het parsen
	-na de clean up
	-na het volledig algoritme
